...
export const NewSession = () => {
  ...
  return (
    <Layout
      ...
      subtitle="Create a session for one inventory file and one target firmware version. The MVP keeps the flow linear and simple."
      backTo="/"
        ...
        <div className="space-y-4">
          <div className="rounded-3xl border border-white/8 bg-white/5 p-6">
            ...
            <ul className="mt-4 space-y-3 text-sm leading-6 text-slate-400">
              <li>1. We create a session from one inventory file.</li>
